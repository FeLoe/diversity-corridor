...
#tab_model(m, dv.labels = names(m), show.ci = F, p.style = 'stars', show.re.var=F)
#tab_model(pooled, dv.labels ='Pooled', show.ci = F, p.style = 'stars', show.re.var=F)
#tab_model(c(m, pooled), dv.labels =c(names(m), 'Pooled'), show.ci = F, p.style = 'stars', show.re.var=F)
